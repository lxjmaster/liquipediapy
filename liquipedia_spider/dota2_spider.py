...
class Dota2Spider(object):

    def __init__(self):

        self._config = Config()
        self.dota2_obj = Dota2()
        self.mongo_obj = MongoObject()
        self.page_url = "https://liquipedia.net/dota2/"
    ...
    def get_teams(self) -> list:
        ...
        teams = self.dota2_obj.get_teams()
        if len(teams) > 0:
            if self.config.has_section("MONGODB"):
                collection = self.mongo_obj.db["dota2_teams"]
                for team in teams:
    ...
    def get_team_info(self, team: dict) -> dict:
        ...
        team_info = self.dota2_obj.get_team_info(team["name"])
    ...
    def get_players(self) -> list:
        ...
        players = self.dota2_obj.get_players()
        if len(players) > 0:
            if self.config.has_section("MONGODB"):
                collection = self.mongo_obj.db["dota2_players"]
    ...
    def get_player_info(self, player: dict) -> dict:
        ...
        player_info = self.dota2_obj.get_player_info(player["name"])
    ...
    def get_tournaments(self, tournament_type=None) -> list:
        ...
        tournaments = self.dota2_obj.get_tournaments(tournament_type)
        if len(tournaments) > 0:
            if self.config.has_section("MONGODB"):
                collection = self.mongo_obj.db["dota2_tournaments"]
    ...
    def get_tournament_info(self, tournament: dict) -> dict:
        ...
        tournament_info = self.dota2_obj.get_tournament_info(page)
    ...
    def main(self):
        ...
        #     input("111")
        tournaments = self.get_tournaments("Tier_1")
        for tournament in tournaments:
